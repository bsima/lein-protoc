...
- `:proto-target-path ` the absolute path or path relative to the project root where the sources should be generated. Defaults to the `:target-path`
...
or the sources can be generated independently with:
